...
public abstract class Packet
{
    ...
    /*\                             Constants                                \*/
    /*\**********************************************************************\*/
    private static ConcurrentHashMap<Integer, Class> Packets = new ConcurrentHashMap<Integer, Class>();
    ...
    public static Packet Instance(int index)
    {
        ...
        {
            Logger.getLogger(Packet.class.getName()).log(Level.SEVERE, "The index was: " + index, ex);
        }
        catch (InstantiationException ex)
        {
            Logger.getLogger(Packet.class.getName()).log(Level.SEVERE, null, ex);
    ...
    {
        this.output = new SocketOutputStream(output);
        
        getOutput().writeInt(getPacketIndex());
        
        write();
    }
    
    public final void read(InputStream input) throws IOException
    {
        this.input = new SocketInputStream(input);
